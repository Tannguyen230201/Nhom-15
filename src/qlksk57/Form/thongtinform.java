...
public class thongtinform extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Nhóm 15: Phần Mềm Quản Lý Khách Sạn");

        jLabel3.setText("Giảng viên hướng dẫn:");

        jLabel4.setText("...");

        jLabel5.setText("Nhóm tác giả:");

        jLabel6.setText("Lê Minh Mạnh");

        jLabel7.setText("Nguyễn Văn Tần");

        jLabel8.setText("Lê Mạnh Tuấn");

        jLabel9.setText("Nguyễn Như Quỳnh");

        jLabel10.setText("Sản phẩm của học phần Thực tập chuyên ngành Hệ thống thông tin");
